...
<body class="bg-gradient-to-br from-rose-100 via-pink-100 to-indigo-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white/70 backdrop-blur-xl border border-white/40 shadow-2xl rounded-3xl p-8 max-w-sm w-full text-center hover:shadow-indigo-200/50 transition-shadow duration-500">
        ...
        <div class="space-y-4">
            <a href="pages/auth/login_admin.php" class="group flex items-center justify-center gap-3 bg-white hover:bg-rose-50 border-2 border-transparent hover:border-rose-200 text-gray-700 py-3.5 px-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
            ...
            <a href="pages/auth/login_user.php" class="group flex items-center justify-center gap-3 bg-gradient-to-r from-rose-400 to-pink-500 hover:from-rose-500 hover:to-pink-600 text-white py-3.5 px-6 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
